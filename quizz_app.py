...
file_path = "https://github.com/AchYassineAM/Quizz/blob/main/99Questions.xlsx"
df = pd.read_excel("https://github.com/AchYassineAM/Quizz/blob/main/99Questions.xlsx")
